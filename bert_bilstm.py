...
def train_model(model, train_loader, dev_loader, num_epochs=5, lr=2e-5, print_every=1,
                save_path='../model/bert_bilstm_model.pth', log_path='../log/bert_bilstm_log.csv'):
...
# 训练模型并保存
train_model(model, train_loader, dev_loader, num_epochs=5, lr=2e-5, print_every=1, save_path='../model/bert_bilstm_model'
                                                                                             '.pth',
            log_path='../log/bert_bilstm_log.csv')